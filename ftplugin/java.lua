...
local config = {
  ...
  cmd = {
    ...
    '-javaagent:'.. vim.fn.expand('~/AppData/Local/nvim-data/mason/packages/jdtls/lombok.jar'),
    -- 💀
    '-jar', vim.fn.expand('~/AppData/Local/nvim-data/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.6.900.v20240613-2009.jar'),
         -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    '-configuration', vim.fn.expand('~/AppData/Local/nvim-data/mason/packages/jdtls/config_win/'),
                    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
 ...
 root_dir = require('jdtls.setup').find_root { '.git', 'mvnw', 'gradlew', 'pom.xml', 'build.gradle' },
  ...
  -- See https://github.com/eclipse/eclipse.jdt.ls/wik'/path/to/unique/per/project/workspace/folder'i/Running-the-JAVA-LS-server-from-the-command-line#initialize-request
